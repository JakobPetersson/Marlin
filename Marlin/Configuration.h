...
#define STRING_CONFIG_H_AUTHOR "(Jakob P)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Mercury One.1"
...
#define PIDTEMPBED
  ...
  // Tuned with M303 E-1 C8 S50
  #define DEFAULT_bedKp 72.01
  #define DEFAULT_bedKi 14.06
  #define DEFAULT_bedKd 245.80
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -34, -4.00, -2.000 } // Rough Z offset (on the safe side)
